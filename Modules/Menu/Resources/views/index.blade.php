                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="table-responsive">
                            <table id="menugroup-datatable" class="table table-bordered key-buttons text-nowrap">
                                <thead>
                                    <tr>
                                        <th class="border-bottom-0" width="5%">id</th>
                                        <th class="border-bottom-0" width="60%">name</th>
                                        <th class="border-bottom-0" width="20%">updated_at</th>
                                        <th class="border-bottom-0" width="15%">action</th>
                                    </tr>
                                </thead>
                                <tbody>
